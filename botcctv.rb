    ...
    system("xdg-open https://youtube.com/channel/UCH8e8uedJ2oYg3o5J2-9qfA");
def ip()
    puts "≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈";
    ...
    puts "http://61.207.158.202:6000";1
    puts "http://61.207.158.202:80";
    puts "http://114.185.129.202:80";
    puts "http://133.208.209.47:60001";
    puts "http://210.230.156.125:8888";
    puts "http://125.174.94.202:80";
    puts "http://220.254.72.200:80";
    puts "http://121.114.75.205:8084";
    puts "http://180.17.132.62:50001";
    puts "http://153.161.27.161:8080";
    puts "http://114.152.150.34:8082";
    puts "http://114.152.150.34:8081";
    puts "http://118.243.25.164:80";
    puts "http://124.110.12.158:80";
    puts "http://118.110.9.158:80";
    puts "http://118.110.9.158:83";
    puts "http://58.1.156.165:80";
    puts "http://218.219.228.113:8";0
    puts "http://153.175.209.45:82";
    puts "http://153.175.209.45:83";
    puts "http://114.151.128.45:80";
    puts "http://60.33.83.161:83";
    puts "http://210.173.7.12:6000";1
    puts "http://61.115.115.49:8082";
    puts "http://61.115.115.49:8083";
    puts "http://61.115.115.49:8081";
    puts "http://210.153.191.157:8081";
    puts "http://210.153.191.157:8080";
    puts "http://221.184.214.157:8001";
    puts "http://180.26.143.8:50001";
    puts "http://119.150.51.6:50000";
    puts "http://211.133.62.7:8080";
    puts "http://58.93.85.121:50001";
    puts "http://120.51.189.191:8080";
...
def menu()
    system("clear");
    system("figlet MR.SANZXCT ");
    puts "\e[91m╔════════════════════════════════════════════════╗"                                             ;
    puts "\e[91m║  \e[91m《•》 AUTHOR   : Mr.AM                       \e[91m ║"
    puts "\e[91m║  \e[91m《•》 MODIFIER : SanzBotzOfficial                    \e[91m ║"
    puts "\e[91m║  \e[91m《•》 TEAM     : Community Clay(Clowns Laught At You          \e[91m ║"
    puts "\e[91m║  \e[91m《•》 GITHUB   : https:github.com/SanzProject208-cyber    \e[91m ║"
    puts "\e[91m║  \e[91m《•》 YOUTUBE  : SanzBotzOfficial             \e[91m ║"
    puts "\e[91m║  \e[91m《•》 FACEBOOK : SanzBotzOfficial           \e[91m ║"
    puts "\e[91m║  \e[91m《•》 INSTAGRAM: @sanzbotzofficial                   \e[91m ║"
    puts "\e[91m╚════════════════════════════════════════════════╝"
    puts ""
    puts "\e[92m╔═══════════════════════════╗"
    puts "\e[92m║\e[92m WATCH CCTV            \e[92m    ║"
    puts "\e[92m╚═══════════════════════════╝"
    puts "Ip Adreass";
    ip
    print "MASUKAN IPnya DISINI 👉 ";
    mask = gets.chomp
